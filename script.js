...
async function sendForm(e) {
    ...
    const res=await(fetch(`https://api.telegram.org/bot768518123951:AAGDDlAOxSQAofJDm5Jsh_gdcMtNcIQDRtw/sendMessage?chat_id=681536405&text=${encodeURIComponent(message)}`));
